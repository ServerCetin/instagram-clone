...
export default function Input({label, type = 'text', ...props}) {
    ...
    return (
        <label className="block relative flex bg-zinc-50 border rounded-sm focus-within:border-gray-400 bg-transparent">
            ...
            {/*{TODO  show hide does not show because props?.value null}*/}
